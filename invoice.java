...
public class SalesInvoiceFrame extends javax.swing.JFrame implements ActionListener, ListSelectionListener {
    ...
    private final DateFormat df = new SimpleDateFormat("dd-MM-yyyy");    //Formating Date ( day - month - year )
   ...
   //$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$//
    ...
    public void actionPerformed(ActionEvent e) {  //implement ActionListener
       ...
       switch (e.getActionCommand()) {
        ...
        case "SaveFile" -> {                 // saveing Data file from table in CSV file
           
            SaveFile();
            }   
            
        case "LoadFile" ->                 // Loading the  CSV file in table
           {
               try {
                   LoadFile() ;
    ...
    //****************************************************************//   
        ...
        case "CreatenewInvoice " -> {       //  create nev invoice with num and date and name 
           
         CreateNewInvoice();
        
        }
            
        case "DeleteInvoice" -> {         //  delete choosen invoice from invoice table
     ...
     //**************************************************************//
        ...
        case "Saveitem" -> {             // save new item in the selected invoice
            
             SaveChoosenItem();
            
         }
        case "Cancelitem" -> {         // cancel or delet the selected item 
    ...
    //***************************************************************//
         ...
         case "InvoiceCancel" -> InvoiceCancelFrame();    // for cancel the frame of create new invoice
         case "InvoiceOK" -> InvoiceOKFrame();            // for ok the frame of create new invoice
        
    //***************************************************************//
         
         
         case "ItemCancel" -> ItemCancelFrame();       // for cancel the frame of create new item
         case "ItemOK"-> ItemOKFrame();               // for ok the frame of create new item
   ...
   //%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%//
      ...
      for (SalesInvoiceHeader header :salesinvoicesMenu) {
       ...
       int result = fileChooser.showSaveDialog(this);
          if (result == JFileChooser.APPROVE_OPTION) {
            ...
            System.out.println(" Bravo you saved invoices CSV file");             //print in run screen you saved the invoice CSV file 
                    
        JOptionPane.showMessageDialog(this, " insert the file to save Items Data  : ", "Invoice Items", JOptionPane.WARNING_MESSAGE); // TO Save Items FILE            
             ...
             System.out.println(" Bravo you saved items CSV file");               //print in run screen you saved the  item CSV file 
             
            }catch (HeadlessException | IOException | NumberFormatException  ex) {
                JOptionPane.showMessageDialog(this, "Error: " + ex.getMessage(), "Folder/File path is not found", JOptionPane.ERROR_MESSAGE); // Handling
          }
     }
    } 
    ...
    private void LoadFile() throws FileNotFoundException, IOException, ParseException {
          JOptionPane.showMessageDialog(this, " select the invoice header file please  : ", "Invoice Header", JOptionPane.WARNING_MESSAGE); // TO CHOOSE HEADER FILE
          JFileChooser openFile = new JFileChooser();
        int result = openFile.showOpenDialog(this);
        if (result == JFileChooser.APPROVE_OPTION) {
            File headerFile = openFile.getSelectedFile();
             try {
                FileReader headerFr = new FileReader(headerFile);          // READING THE  FILE
                ...
                while ((headerItem = headerBr.readLine()) != null) {
                    ...
                    int invoiceNumber = Integer.parseInt(invoiceNumberStr);  // TO turn it from string to int
                    Date invoiceDate = df.parse(invoiceDateStr);            // using dateformat turn date from string into Date
                ...
                if (result == JFileChooser.APPROVE_OPTION) {
                    ...
                    try (FileReader itemsFr = new FileReader(itemsFile)) {
                        ...
                        while ((itemsItem = itemsBr.readLine()) != null) {
                            String[] itemParts = itemsItem.split(",");     // to split items of items table
        ...
        InvoicesRunScreen();              //to show the detailed load in run screen 
 }
    ...
    //***********************************************************//
     ...
     int selectedRowIndex = SalesInvoiceTable.getSelectedRow();
        if (selectedRowIndex >= 0) {
            SalesInvoiceHeader row = HeaderTable.getSalesinvoicesMenu().get(selectedRowIndex);  // select Row from Table
            ...
            ItemsTable.fireTableDataChanged();     // Table drow itself
    }
 ...
 //*******************************************************//
    ...
    private void InvoiceCancelFrame() {
        ...
        headerDisplay = null;           // cancle dialog frame
    }  
    ...
    private void InvoiceOKFrame() {
        ...
        try {
            ...
            HeaderTable.fireTableDataChanged();        //draw table if Data changed                    
   ...
   //****************************************************//
    ...
    private void ItemOKFrame() {
       ...
       //ItemsTable.getItemsList().add(invoiceitem);
...
//****************************************************//
    ...
    private void CreateNewInvoice() {        // create dialog
